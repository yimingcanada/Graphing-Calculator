...
public class Parser {
	...
	static double evaluate (String input)
	{
				...
				for (int i= startBracket; i < input.length() ; i ++) //starts at the index of the first bracket found
				{
					...
					else if (input.charAt(i) == ')')
					{
						...
						if (bracketCount ==0)//if the associated bracket is found
						{
							...
							{
								//System.out.println("no more brackets ");
								done = true;
		...
		//System.out.println("Brackets done");
		//System.out.println(input);
		...
		while(operators.contains("^"))
		{
			...
			//System.out.println("Starting exponentials ");
		...
		{
			//System.out.println("Starting multplication/division ");
			//System.out.println("numbers  " + numbers);
			//System.out.println("operators  " + operators);
		...
		while(operators.contains("+") )//||operators.contains("-")
		{
			...
			//System.out.println("Starting addition/subtraction ");
			...
			/*for (int i = 0 ; i < operators.size() ; i ++)
			{
				if (operators.get(i).contains("-"))//goes through the operators and tries to find the subtraction sign
				{
					numbers.set(i, numbers.get(i) - numbers.get(i+1));
					numbers.remove(i+1);
					operators.remove(i);
